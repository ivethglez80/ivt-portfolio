...
//             <div className="ml-10 py-0 px-2 bg-sky-500 text-gray-900">
//             {location.pathname === "/" ? <p>ONLINE PORTFOLIO</p> : <p>IVETH GONZALEZ</p>}
//             </div>
            
//             <li className={location.pathname === "/" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/" className="ml-5 hover:text-sky-500"><FormattedMessage id="nav.home" defaultMessage="Home" /></Link>
//             </li>
            
//             <li className={location.pathname === "/about" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/about" className="ml-5 hover:text-sky-500"><FormattedMessage id="nav.about" defaultMessage="Acerca de" /></Link>
//             </li>
            
//             <li className={location.pathname === "/profile" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/profile" className="ml-5 hover:text-sky-500"><FormattedMessage id="nav.profile" defaultMessage="Perfil" /></Link>
//             </li>

//             <li className={location.pathname === "/portfolio" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/portfolio" className="ml-5 hover:text-sky-500"><FormattedMessage id="nav.portfolio" defaultMessage="Portfolio" /></Link>
//             </li>
            
//             <li className={location.pathname === "/contact-info" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/contact-info" className="ml-5 hover:text-sky-500"><FormattedMessage id="nav.contact" defaultMessage="Contacto" /></Link>
//             </li>

//             <li className={location.pathname === "/blog" ? "text-sky-500" : "text-slate-200"}>
//             <Link to="/blog" className="ml-5 mr-0"><FormattedMessage id="nav.blog" defaultMessage="Blog" /></Link>
//             </li>

//         </div>
//         <div className="border-t-2 border-slate-200 w-20">   
//         </div>
//         <div className="mr-10">
//             <button onClick={()=>languaje.setLang('es-Ar')} className="ml-0 mr-5">
//                 {
